...
* URL: http://localhost:8000/register
  * Method: `POST`
  * Parameter: `username`
  * Attack: `example@gmail.com AND 1=1 -- `
  * Evidence: ``
  * Other Info: `The page results were successfully manipulated using the boolean conditions [example@gmail.com AND 1=1 -- ] and [example@gmail.com AND 1=2 -- ]
